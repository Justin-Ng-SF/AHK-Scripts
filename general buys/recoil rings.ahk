...
Start(){
    ...
    Loop 100{
        ...
        MouseMove, 614, 78 ;
        sleep 100 ;
        Click, 614, 78 ; walk in general store
        sleep 6000 ;

        MouseMove, 200, 188 ;
        sleep 100 ;
        Click 200, 188 ; talk/trade melee trainer
        sleep 500 ;
    	...
    	Loop 4
    	{
    		Send {WheelDown} ; scroll shop down
    		sleep 25 ;
    	}

        MouseMove, 184, 297 ;
        sleep 100 ;
        Click, right, 184, 297 ; right click recoils
        sleep 100 ;

        MouseMove, 184, 322 ;
        sleep 100 ;
        Click, 184, 322 ; buy x recoils
        sleep 750 ;
